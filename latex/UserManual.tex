...
\item What are the required input files a user needs to upload before the visual exploration can start? If this is covered in the installation manual, we should mention it here.
\item 
\end{itemize}
