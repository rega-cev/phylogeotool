...
public class BasicVisualizationServerMine<V, E> extends JPanel 
     ...
     */
	public BasicVisualizationServerMine(Layout<V,E> layout) {
     ...
     */
	public BasicVisualizationServerMine(Layout<V,E> layout, Dimension preferredSize) {
	 ...
	 * @param renderer
	 */
	public BasicVisualizationServerMine(VisualizationModel<V,E> model) {
...
//        renderContext.setScreenDevice(this);
	...
	protected class VisualizationListener extends ComponentAdapter {
		protected BasicVisualizationServerMine<V,E> vv;
		public VisualizationListener(BasicVisualizationServerMine<V,E> vv) {
			this.vv = vv;
		}
