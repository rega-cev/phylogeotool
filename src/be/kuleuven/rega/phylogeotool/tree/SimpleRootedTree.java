...
//        if( ! map.isEmpty() ) {
    ...
    public Node createExternalNode(Taxon taxon) {
        ...
        SimpleRootedNode node = new SimpleRootedNode(taxon, nodeIdCounter++);
    ...
    public SimpleRootedNode createInternalNode(List<? extends Node> children) {
        SimpleRootedNode node = new SimpleRootedNode(children, nodeIdCounter++);
    ...
    public class SimpleRootedNode extends BaseNode {
        public SimpleRootedNode(Taxon taxon, int id) {
            this.children = Collections.unmodifiableList(new ArrayList<Node>());
            this.taxon = taxon;
            this.id = id;
        }

        public SimpleRootedNode(List<? extends Node> children, int id) {
