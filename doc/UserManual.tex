...
When the user hovers the mouse over a node in the cluster phylogeny, both the attribute histogram or bar chart and the map are updated. 
The attribute chart will be extended (i.e. extra bars will be shown on top of the original chart for each value) with the data that is located in the cluster over which the mouse hovers. %GB: extended?
...
The colours in the radial tree correspond to the colors of the clusters in the panel showing the clustered phylogenetic tree. %GB: you alternate between American and British English in the document; do you prefer 'color' or 'colour'?
\break
\break
...
\item Color Tree
\begin{itemize} 
\item Yes: Download a phylogenetic tree where the clusters shown in the Phylogeotool are colored on top of it.
\item No: Download a phylogenetic tree with no coloring.
\end{itemize}
\item Show node tips
\begin{itemize} 
\item Yes: Include leaf names in the phylogenetic tree.
\item No: Do not include leaf names in the phylogenetic tree.
\end{itemize}
\item Output Format: The output format in which you want your tree to be downloaded
\begin{itemize} 
\item PDF
\item PNG
\item NEXUS
